...
export default function DiscordMessage({
  ...
  const highlightMessage =
    (slots?.default as ReactElement[])?.some?.(({ props = {} }) => props?.highlight && props?.type !== 'channel') ||
    ...
    <div className={messageClasses}>
      ...
      <div className="discord-message-content">
        ...
        <div className="discord-message-body">
          ...
          {slots.embeds}
          {slots.actions}
          {ephemeralMessage && <div className="discord-message-ephemeral-notice">Only you can see this</div>}
          {slots.reactions}
        </div>
      </div>
    </div>
