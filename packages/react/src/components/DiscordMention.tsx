...
import '@discord-components/core/dist/styles/discord-mention.scss'
...
export default function DiscordMention({ children, roleColor, profile: profileKey, type = 'user' }: DiscordMentionProps): ReactElement {
  ...
  const colorStyle = color && type === 'role' ? { color, backgroundColor: hovering ? colors.hover : colors.background } : {}
