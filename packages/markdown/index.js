...
function htmlTag(tagName, content, attributes, isClosed = true, state = {}) {
  ...
  if (attributes.class && state.scssModuleNames) {
    attributes.class = attributes.class
      .split(' ')
      .map((cl) => state.scssModuleNames[cl] || cl)
      .join(' ')
  }
 ...
 * @param {Object} [options.scssModuleNames] An object mapping css classes to css module classes
 */
function toHTML(source, options, customParser, customHtmlOutput) {
  ...
  const state = {
    ...
    cssModuleNames: options.scssModuleNames || null,
